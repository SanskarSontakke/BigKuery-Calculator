...
class EvalContext:
    ...
    precision: int = 27  # bits (~8 digits, 8 * 3.32)
...
class Evaluator:
    ...
    def evaluate(self, expr: Union[str, ASTNode]) -> EvalResult:
        ...
        try:
            ...
            return EvalResult.from_error(format_error(f"Parse error: {e}"))
        except ValueError as e:
            return EvalResult.from_error(format_error(f"Value error: {e}"))
        except ZeroDivisionError:
            return EvalResult.from_error(format_error("Division by zero"))
        except Exception as e:
            return EvalResult.from_error(format_error(str(e)))
