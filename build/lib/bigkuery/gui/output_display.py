"""
OutputDisplay - Result display widget.
"""
...
class OutputDisplay(QFrame):
    ...
    Shows the computed result of expressions with large,
    readable text and copy functionality.
    """
    ...
    def _setup_ui(self):
        ...
        layout.setContentsMargins(5, 5, 5, 5)  # Reduced margins as scroll area has frame
        ...
        self._label.setWordWrap(True)  # Default to wrap
